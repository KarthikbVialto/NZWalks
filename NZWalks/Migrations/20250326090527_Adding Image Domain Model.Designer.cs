...
namespace NZWalks.Migrations
{
    ...
    [Migration("20250326090527_Adding Image Domain Model")]
    partial class AddingImageDomainModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NZWalks.Models.Domains.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48e7ab23-d373-45a5-96f7-0bac5756f643"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("e9b7c31a-9109-46c4-8547-a54089d08070"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("b3072775-5ff6-4816-abfe-aca7dada18e3"),
                            Name = "Hard"
                        });
                });

            modelBuilder.Entity("NZWalks.Models.Domains.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
